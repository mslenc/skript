...
class SkNativeMethod(name: String, val thisParam: KParameter, val params: List<ParamInfo<*>>, val impl: KFunction<*>, override val expectedClass: SkClassDef) : SkMethod(name, params.map { it.name }) {
